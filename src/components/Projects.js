    ...
    <>
      ...
      <div className="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div className="container text-center py-5">
          <h1 className="display-4 text-white animated slideInDown mb-3">Projects</h1>
        </div>
      </div>
      ...
      <div className="container-xxl py-5">
        <div className="container">
          ...
          <div className="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
            <div className="project-item border rounded h-100 p-4" data-dot={1}>
            ...
            <div className="project-item border rounded h-100 p-4" data-dot={2}>
              <div className="position-relative mb-4">
            ...
            <div className="project-item border rounded h-100 p-4" data-dot={3}>
              <div className="position-relative mb-4">
            ...
            <div className="project-item border rounded h-100 p-4" data-dot={4}>
              <div className="position-relative mb-4">
            ...
            <div className="project-item border rounded h-100 p-4" data-dot={5}>
              <div className="position-relative mb-4">
            ...
            <div className="project-item border rounded h-100 p-4" data-dot={6}>
              <div className="position-relative mb-4">
            ...
            <div className="project-item border rounded h-100 p-4" data-dot={7}>
              <div className="position-relative mb-4">
            ...
            <div className="project-item border rounded h-100 p-4" data-dot={8}>
              <div className="position-relative mb-4">
            ...
            <div className="project-item border rounded h-100 p-4" data-dot={9}>
              <div className="position-relative mb-4">
